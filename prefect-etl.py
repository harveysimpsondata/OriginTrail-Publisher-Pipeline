...
@task(log_prints=True, retries=3, retry_delay=datetime.timedelta(seconds=10))
def ingest_data(API_KEY, DB_USERNAME, DB_PASSWORD, DB_HOST, DB_PORT, DB_NAME):
...
def main_flow():
    ...
    ingest_data(API_KEY, DB_USERNAME, DB_PASSWORD, DB_HOST, DB_PORT, DB_NAME)
